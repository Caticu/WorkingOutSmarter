...
public class ProfileModel {
    ...
    public void saveProfile(String userId, String name, int age, double height, double weight, String imageUri, OnProfileSaveCallback callback) {
        Profile profile = new Profile(name, age, height, weight, userId, imageUri);
